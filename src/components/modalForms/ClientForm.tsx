...
export const ClientForm: FC<Props> = ({
  ...
  const handleFormSubmit = (values: IClientForm) => {
    ...
    if (formData.transfer_reason === "") formData.transfer_reason = undefined;
  ...
  const formikInitialValues: IClientForm = clientData
    ? {
      ...
      // Campo de traspaso
      transfer_reason: clientData.transfer_reason || "",
              ...
              return (
                <Form className="w-full flex flex-col">
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-4">
                    ...
                    {/* Campo de motivo de traspaso (solo si el estado es "Traspaso") */}
                    {values.status === "Traspaso" && (
                      <div className="col-span-full space-y-4 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                        <h3 className="text-lg font-semibold text-blue-800 dark:text-blue-300 mb-2">
                          Informacion de Traspaso
                        </h3>

                        <div>
                          <label htmlFor="transfer_reason" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                            Motivo de Traspaso *
                          </label>
                          <Field
                            as="textarea"
                          ...
                          />
                          <ErrorMessage name="transfer_reason" component="div" className="text-red-500 text-sm mt-1" />
                        </div>
                      </div>
                    )}
